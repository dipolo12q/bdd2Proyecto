...
public:
    ...
    {
        int cont = 1;
        cout << setw(5) << cont << setw(5) << "key" << setw(20) << "Name" << setw(13) << "Class" << setw(15) << "Role" << setw(6) << "Tier" << setw(10) << "Score" << setw(12) << "winRate" << setw(12) << "rolRate" << setw(12) << "pickRate" << setw(12) << "banRate" << setw(10) << "Trend" << setw(10) << "Kda" << "\n";
        set<long> visited;
        fopen(fileName);
        isfopen
        {
